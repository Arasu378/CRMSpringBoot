package com.kyrostechnologies.crm.application.deals.datatier;

import com.kyrostechnologies.crm.dbconstants.DealsDBConstants;
...
public class DealsDataTier implements RowMapper<DealModel> {
    @Override
    public DealModel mapRow(ResultSet rs, int i) throws SQLException {
