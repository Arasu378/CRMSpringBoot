...
public class ProfilePictureController {
    ...
    @RequestMapping(method = RequestMethod.GET,value = "/profilePicture/{ProfilePictureId}")
    public @ResponseBody
    ...
    @RequestMapping(method = RequestMethod.POST,value = "/profilePicture")
    public @ResponseBody
    ...
    @RequestMapping(method = RequestMethod.PUT,value = "/profilePicture")
    public @ResponseBody
    ...
    @RequestMapping(method = RequestMethod.DELETE,value = "/profilePicture")
    public @ResponseBody
